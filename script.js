function KelvinEmCelsius() {
    ...
    if (temperaturaDigitada == '') {
        ...
        res.innerHTML = "<p><b>Resultado:</b><br>" + temperaturaC + "° Kelvin equivale a " + temperaturaDigitada + "° Celsius.</p>";
    }
}
...
function KelvinEmFahrenheit() {
    ...
    if (temperaturaDigitada == '') {
        ...
        res.innerHTML = "<p><b>Resultado:</b><br>" + temperaturaDigitada + "° Kelvin equivale a " + temperaturaF.toFixed(1) + "° Fahrenheit.</p>";
    }
}
...
function CelsiusEmKelvin() {
    ...
    if (temperaturaDigitada == '') {
        ...
        res.innerHTML = "<p><b>Resultado:</b><br>" + temperaturaK.toFixed(1) + "° Kelvin equivale a " + temperaturaDigitada + "° Celsius.</p>";
    }
}
...
function CelsiusEmFahrenheit() {
    ...
    if (temperaturaDigitada == '') {
        ...
        res.innerHTML = "<p><b>Resultado:</b><br>" + temperaturaF.toFixed(1) + "° Fahrenheit equivale a " + temperaturaDigitada + "° Celsius.</p>";
    }
}
...
function FahrenheitEmCelsius() {
    ...
    if (temperaturaDigitada == '') {
        ...
        res.innerHTML = "<p><b>Resultado:</b><br>" + temperaturaC.toFixed(1) + "° Celsius equivale a " + temperaturaDigitada + "° Fahrenheit.</p>";
    }
}
